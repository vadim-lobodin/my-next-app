...
export interface MainToolbarButtonProps
  ...
  typographyVariant?: "header-3-semibold" | "default"
}

const MainToolbarButton = React.forwardRef<HTMLButtonElement, MainToolbarButtonProps>(
  ({ variant = "default", size = "default", textVariant = "regular", typographyVariant = "header-3-semibold", children, icon, trailingIcon, className, disabled, ...props }, ref) => {
...
// ===== WEB TOOLBAR =====
// Simplified toolbar for web layouts — no window chrome, no panel toggles

export interface MainToolbarWebProps extends React.HTMLAttributes<HTMLDivElement> {
  projectName?: string
  branchName?: string
  taskName?: string
  taskIcon?: string
...
export const MainToolbarWeb = React.forwardRef<HTMLDivElement, MainToolbarWebProps>(
  ({
    className,
    ...
    return (
      <div
        ref={ref}
        className={cn("flex items-center justify-between w-full pl-0 pr-3 pt-0 pb-2", className)}
        {...props}
      >
        <div className="flex items-center gap-0.5">
          <MainToolbarButton textVariant="disabled" typographyVariant="default">
            {projectName}
          </MainToolbarButton>
          <div className="flex-shrink-0 size-5 flex items-center justify-center">
            <Icon fleet="branch" size="sm" className="opacity-35" />
...
MainToolbarWeb.displayName = "MainToolbarWeb"

/** @deprecated Use MainToolbar instead */
export const MainToolbarDesktop = MainToolbar
