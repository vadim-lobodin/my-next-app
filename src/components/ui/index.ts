...
// Air Web Sidebar - Collapsible nav sidebar for web layouts with task list
export {
  WebSidebar,
...
// Air Selection Card - Card with status states for selections/integrations
export {
  SelectionCard,
  type SelectionCardStatus,
  type SelectionCardRootProps,
  type SelectionCardTitleProps,
  type SelectionCardDescriptionProps,
  type SelectionCardLabelProps,
  type SelectionCardTextProps,
} from "./selection-card"

// Air Page Template - Content island with header/subheader for web layouts
export {
  PageTemplate,
...
// Air Code Snippet - Expandable code block with file header and diff stats
export {
  CodeSnippet,
  type CodeSnippetProps,
} from "./code-snippet"

// Air Terminal Snippet - Expandable terminal output with status states
export {
  TerminalSnippet,
  type TerminalSnippetProps,
  type TerminalSnippetStatus,
} from "./terminal-snippet"

// Air Permission Widget - Tool permission prompt with numbered answers
export {
  PermissionWidget,
  AnswerBadge,
  AnswerOption,
...
} from "./permission-widget"

// Air Question Widget - Multi-choice question with segmented tabs and answers snippet
export {
  QuestionWidget,
  InputQuestionWidget,
  AnswersSnippet,
  type QuestionWidgetProps,
  type InputQuestionWidgetProps,
  type QuestionAnswer,
  type AnswersSnippetProps,
  type AnswersSnippetEntry,
} from "./question-widget"
